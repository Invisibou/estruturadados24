...
do
{
    ...
    if(!double.TryParse(numberStr, out double number)) //TryParse = Tente Validar, isso que você ta pedindo é verdadeiro ou não.
    {
        break;
    }
    numbers.Add(number);
...
foreach(Person p in people) //para cada
{
